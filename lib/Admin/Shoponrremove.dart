...
import '../Shop/Navigation bar shopowner.dart';
import 'Adminhomepage.dart';

class Shoponrremove extends StatefulWidget {
  const Shoponrremove({super.key});

  @override
  State<Shoponrremove> createState() => _ShoponrremoveState();
}

class _ShoponrremoveState extends State<Shoponrremove> {
  @override
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Icon(
                    CupertinoIcons.location,color: Colors.grey,
                    size: 32,
                  ),
                  Row(
                    children: [
